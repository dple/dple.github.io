...
Personally, I found that the Rareskills book is great source. It explained and demosntrated by Python step-by-step how to a practical Zero-Knowlegde Proof system work. Their Python code was consolidated in my [Github repo](https://github.com/dple/understanding-zkp).    